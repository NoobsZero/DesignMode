...
def get_url_lis(name='六盘水市', url='https://poi.mapbar.com/liupanshui/GA0/'):
    ...
    proxies = {"check_count": 3, "fail_count": 0, "last_status": 1, "last_time": "2021-03-11 16:20:45",
               "proxy": "150.109.32.166:80", "region": "", "source": "", "type": ""}
    # 模拟浏览器发送HTTP请求
