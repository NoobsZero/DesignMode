...
if __name__ == '__main__':
    # main()
    with open(r'F:\chejian\chejian\CheJianConfig\chejian_refactor.sql',encoding='utf8', errors='ignore') as file_obj:
        for i in range(100):
