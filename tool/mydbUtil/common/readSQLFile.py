...
if __name__ == '__main__':
    sqldata = ReadSQLFile(r'C:\Users\afakerchen\Desktop\emData_chayan_4419_20210806144348\chayan\sqlFiles\4419\2021-08-06\photo_info_20210806142116.sql', sqlHader=('DROP', 'CREATE', 'INSERT'))
    # print(sqldata.get_SQL_columns())
    # print(sqldata.get_SQL_data())
    sqldata.get_SQL_dict()
    # odb = OperateDB(os.path.join(project_root_path(), 'source\mydb.conf.json'))
    # for sql in sqldata.get_SQL_List():
    #     print(sql)
    #     odb.insert(sql)
