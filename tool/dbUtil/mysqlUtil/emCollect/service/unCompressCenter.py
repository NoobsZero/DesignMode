...
class UnCompressCenter:
    ...
    def start(self):
        ...
        for item in self.srcFilePaths:
            isOk,message = self.UnCompressStart(self.generateRecord,item)
