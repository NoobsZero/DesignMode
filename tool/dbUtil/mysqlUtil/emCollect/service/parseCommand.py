...
class ReadCommandParameter:
    ...
    def UseAge(self):
        print("")
        print("USEAGE:")
        print("\tpython3 [projectName] [-h]  [--isRun] [--isDebug] [--sourceContent  source] [--sourceType type]  ")
        print("\t")
        print("\t-h\t\t\t: 帮助信息")
    ...
    def parseCommandArgs(self, argv):
        # print argv
        try:
            opts, args = getopt.getopt(argv, "hc:t:", ["sourceType=", "sourceContent=", "isDebug", "isRun"])
